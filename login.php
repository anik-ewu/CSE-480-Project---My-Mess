...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "select * from member where user_name ='".$uname."' AND password='".$password."' limit 1";
...
<html>
    ...
    <body>
        ...
        <div class="right_card">
            <form method="POST" action="login.php" class="form_style">
                <fieldset>
                    <legend>login as member</legend><br>
                    <label for="uname">User Name:</label><br>
                    <input type="uname" name="uname" id="uname" placeholder="User Name..."><br>
